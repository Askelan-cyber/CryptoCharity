...
donor_menu = ["View Charity Event Information", "Donate", "View Total Donations", "View Itemized Donations"]
charity_admin_menu = ["Register Charity Event", "Approve Charity Event", "Add Administrator", "View Charity Event Information", "Cancel Charity Event"]
recipient_menu = ["View Total Donations", "View Itemized Donations", "View Charity Event Info"]
